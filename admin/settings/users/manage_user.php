            ...
            <div class="modal-body">
                <form id="addUserForm" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="c_employee_code" name="c_employee_code" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="c_realname" name="c_realname" required>
                    </div>
                    <div class="mb-3">
                        <label for="group" class="form-label">Group</label>
                        <select class="form-select" id="c_group" name="c_group" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="c_department" name="c_department" required>
            ...
            <div class="modal-body">
                <form id="editUserForm" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="edit_group" name="c_group" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="edit_department" name="c_department" required>
