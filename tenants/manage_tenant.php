...
<div class="card mt-3">
    ...
    <div class="col-md-4 form-group">
        ...
        <select name="c_phase" id="c_phase" class="custom-select form-control" autocomplete="off" required>
    ...
    <div class="col-md-4 form-group">
        ...
        <input type="number" id="c_block" name="c_block" class="form-control" value="<?php echo htmlspecialchars($c_block); ?>" oninput="concatenateValues();" onblur="padBlockValue(); limitInputLength(this, 3);" required>
    </div>
    <div class="col-md-4 form-group">
    ...
    <div class="col-md-12">
        ...
        <input type="text" class="form-control txt" id="tenant_acc_no" name="tenant_acc_no" value="<?php echo htmlspecialchars($c_account_no) ?>" readonly required>
    </div>
    <form id="tenant-form" method="post" action="">
            <input type="hidden" name="id" value="<?php echo $tenantId ? $tenantId : '' ?>">
            <div class="col-md-4">
                <label for="lname" class="form-label">Last Name</label>
                <input type="text" class="form-control txt" id="tenant_lname" name="tenant_lname" value="<?php echo htmlspecialchars($c_last_name) ?>" required>
            </div>
            <div class="col-md-4">
                <label for="fname" class="form-label">First Name</label>
                <input type="text" class="form-control txt" id="tenant_fname" name="tenant_fname" value="<?php echo htmlspecialchars($c_first_name) ?>" required>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control txt" id="tenant_address" name="tenant_address" value="<?php echo htmlspecialchars($c_address) ?>" required>
            </div>
            <div class="col-md-4">
                <label for="city_prov" class="form-label">City/Province</label>
                <input type="text" class="form-control txt" id="tenant_city_prov" name="tenant_city_prov" value="<?php echo htmlspecialchars($c_city_prov) ?>" required>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control txt" id="tenant_mobile" name="tenant_mobile" value="<?php echo htmlspecialchars($c_mobile_no) ?>" required>
            </div>
            <div class="col-md-4">
                <label for="email" class="form-label">Email Address</label>
                <input type="text" class="form-control txt" id="tenant_email" name="tenant_email" value="<?php echo htmlspecialchars($c_email) ?>" required>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="date" class="form-control txt" id="tenant_birthday" name="tenant_birthday" value="<?php echo htmlspecialchars($c_birthday) ?>" required>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control txt" id="tenant_area" name="tenant_area" value="<?php echo htmlspecialchars($c_lot_area) ?>" required>
            </div>
            <div class="col-md-4">
                <label for="price_sqm" class="form-label">Price Sqm</label>
                <input type="text" class="form-control txt" id="tenant_sqm" name="tenant_sqm" value="<?php echo htmlspecialchars($c_price_sqm) ?>" required>
            </div>
            <div class="col-md-12">
                <label for="remarks" class="form-label">
                    Remarks 
                </label>
                <textarea class="form-control txt" rows="5" cols="50" id="tenant_remarks" name="tenant_remarks" required><?php echo htmlspecialchars($c_remarks) ?></textarea>
            </div>
