...
<form id="car-type-form">
    ...
    <table class="align-left">
        <tr>
            ...
            <td>
                <div class="form-group">
                    <input type="text" class="hidden_fields" value="<?php echo htmlspecialchars($accountNo) ?>" readonly>
                </div>
            </td>
            <td>
                <div class="form-group">
        ...
        <tr>
            ...
            <td>
                <div class="form-group">
                    <input type="text" class="form-control" id="new_acc_copy" name="new_acc_copy" oninput="copyAccs()" required>
                </div>
            </td>
        </tr>
    </table>
    <div class="form-group">
        ...
        <textarea class="form-control txt" rows="2" cols="50" id="notes_copy" name="notes_copy" oninput="copyAccs()" required></textarea>
    </div>
            ...
            if (!empty($carPayments)) {
                foreach ($carPayments as $index => $car) { ?>
                    <tr>
                        ...
                        <input type="text" id="transferred_by" name="transferred_by" class="hidden_fields" value="<?php echo $car['c_encoded_by'] ?>" readonly>
