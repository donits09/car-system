...
Class Master{
	...
	function save_or_payment() {
		...
		$values = "'$maxId','$c_account_no_or', '$c_tran_type', '$c_or_no', '$c_or_paydate', '$c_or_amount', '$c_encoded_by', '$c_tran_date', '$c_tran_date','$c_mop','$c_bank','$c_check_no','$c_remarks', '" . (!empty($atap_id) ? $atap_id : '0') . "'";
